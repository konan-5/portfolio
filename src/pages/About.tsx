...
const About: React.FC = () => {
    return (
        <Element name={'about'} id='about' className='py-16'>
            <div className='container mx-auto'>
                ...
                <h3 className='max-w-[90%] md:max-w-[80%] mx-auto mt-10 text-sm md:text-lg text-center dark:text-secondary' id="about-description">
