...
const Header: React.FC = () => {
    ...
    return (
        <>
            <header
                className={`fixed z-40 top-0 left-0 h-[70px] w-full flex items-center bg-secondary dark:bg-grey backdrop-blur-[30px] shadow-[0_3px_6px_3px_rgba(0,0,0,0.4)] transition-all duration-300`}>
